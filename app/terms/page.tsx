      ...
      <main className="py-12 sm:py-16 px-5 sm:px-6 bg-white">
        <article className="max-w-3xl mx-auto prose prose-gray prose-lg">
          ...
          <p className="uppercase text-sm leading-relaxed">
            ...
            THE ACCURACY, COMPLETENESS, OR USEFULNESS OF THE SERVICES, AND YOU
            RELY ON THE SERVICES AT YOUR OWN RISK. NO ADVICE OR INFORMATION,
            ...
            TERMS. SOME STATES MAY PROHIBIT A DISCLAIMER OF WARRANTIES AND YOU
          ...
          <p className="uppercase text-sm leading-relaxed">
            WE AND OUR SUPPLIERS, LICENSORS, AND CONTRACTORS WILL NOT BE LIABLE
            FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR
            EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO, DAMAGES FOR LOSS OF
            PROFITS, GOODWILL, USE, DATA, OR OTHER INTANGIBLE LOSSES (EVEN IF WE
            HAVE BEEN ADVISED OF THE POSSIBILITY OF THESE DAMAGES), RESULTING
            FROM YOUR USE OF OUR SERVICES. UNDER NO CIRCUMSTANCES WILL OUR TOTAL
            LIABILITY ARISING OUT OF OR RELATED TO YOUR USE OF THE SERVICES,
            ...
            THAT YOU HAVE PAID TO US FOR YOUR USE OF THE SERVICES. BECAUSE SOME
          ...
          <p>
            ...
            party through use of the Services.
          </p>
          ...
          <p>
            Enforcement of these Terms will be governed by the laws of the State
            of California, excluding its conflict and choice of law principles.
            The exclusive jurisdiction and venue for any claims arising out of or
            related to these Terms or your use of the Services will lie in the
            state and federal courts located within the State of California, and
            you irrevocably agree to submit to the jurisdiction of such courts.
          </p>
          <p>
            ...
            and agreed to by us in writing. In the event that a court of
            competent jurisdiction finds any provision of these Terms to be
