const trustPoints = [
  {
    ...
    description: "Every member is a medical student or healthcare trainee. No random landlords, no strangers.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Real Profiles, Real People",
    description: "See photos, bios, schools, and specialties before you connect. Know who you're reaching out to.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
